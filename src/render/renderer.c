...
static const char* s_voxel_frag_src =
    ...
    "     *   ao_mode 4-5: conveyor belt / hazard stripes\n"
    ...
    "    float ao = 1.0;\n"
    "    if (v_ao_mode > 3.5) {\n"
    "        /* Conveyor belt modes (4 = belt surface, 5 = hazard stripes) */\n"
    "        if (v_ao_mode > 4.5) {\n"
    ...
    "                float edge_dark = smoothstep(0.0, 0.08, min(tile_frac, 1.0 - tile_frac));\n"
    "                base_color *= mix(0.7, 1.0, edge_dark);\n"
    "            } else {\n"
